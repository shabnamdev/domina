 ...
 *
 */
if ( ! class_exists( 'DOM_Field_sortable' ) ) {
  class DOM_Field_sortable extends DOM_Fields {
    ...
    public function render() {
      ...
      echo '<div class="dom-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="dom-sortable-item">';

          echo '<div class="dom-sortable-content">';
          ...
          DOM::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="dom-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
