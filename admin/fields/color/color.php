 ...
 *
 */
if ( ! class_exists( 'DOM_Field_color' ) ) {
  class DOM_Field_color extends DOM_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="dom-color"'. $default_attr . $this->field_attributes() .'/>';
