 ...
 *
 */
if ( ! class_exists( 'DOM_Field_sorter' ) ) {
  class DOM_Field_sorter extends DOM_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'domina-pro' ),
        'disabled_title' => esc_html__( 'Disabled', 'domina-pro' ),
      ) );
      ...
      echo '<div class="dom-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="dom-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="dom-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="dom-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="dom-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="dom-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="dom-disabled">';
